...
<form name="oauth1_authorize_form" id="oauth1_authorize_form" action="<?php echo esc_url( $url ); ?>" method="post">
  ...
  <div class="login-info">
    ...
    <p><?php
printf(
  __( 'Vuoi connetterti a '.get_bloginfo( 'name' ).'?' )
)
      ?></p>
  ...
  <p class="submit">
    <button type="submit" name="wp-submit" value="Autorizza" class="button button-primary button-large"><?php _e('Authorize'); ?></button>
