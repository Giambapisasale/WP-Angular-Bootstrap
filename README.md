...
In particolare, la versione **minima** di PHP necessaria è la **5.4**, la versione **MASSIMA** di PHP supportata è la **5.5** .
Inoltre Sono necessari inoltre le seguenti estensioni PHP:
